export default {
	...
	panel: {
		...
		settingsAbout: {
			caption: 'About',
			developedBy: 'オリジナルのDuet Web Interfaceの開発者',
			modifiedBy: 'WorkBee Controlへの変更者',
			for: 'for',
			licensedUnder: '以下の条件にてライセンスされています．'
		},
		settingsAppearance: {
			caption: '外観',
			darkTheme: 'ダークテーマ',
		...
		settingsTouchProbe: {
			...
			touchProbeFeedRateCaption: '送り速度 (mm/min)',
			touchProbeXDimensionCaption: 'X 寸法(mm)',
			touchProbeYDimensionCaption: 'Y 寸法(mm)',
			touchProbeZDimensionCaption: 'Z 寸法(mm)',
			touchProbeXOffsetCaption: 'X軸 オフセット (mm)',
			touchProbeYOffsetCaption: 'Y軸 オフセット (mm)',
			touchProbeZOffsetCaption: 'Z軸 オフセット (mm)',
			touchProbeRevert: 'デフォルトに戻す',
			touchProbeTriggerCaption: 'タッチプローブのトリガーレベル',
			touchProbeActiveHigh: 'アクティブ ハイ',
			touchProbeActiveLow: 'アクティブ ロー',
