export default {
	...
	button: {
		...
		work: {
			caption: 'Set {0}',
			captionAll: 'Set Work XYZ',
			title: 'Set the work {0} axis',
			titleAll: 'Set the work {0} XYZ'
		},
		workGoto: {
	...
	jobProgress: {
		...
		printing: 'Machining {0}, {1} complete',
		printed: 'Finished {0}, 100 % complete',
	...
	panel: {
		...
		babystepping: {
			caption: 'Z-Axis Adjustment Offset',
		...
		movement: {
			...
			noAxes: 'No Axes',
			workSelect: 'Selected Work Coordinate System',
